...
def test_one():
    ...
    #print(sol_file)
    #mainet:
    #  **kwargs: optional arguments. Used "solc", "etherscan_only_source_code", "etherscan_only_bytecode","", "export_dir"
    #slither = Slither(sol_file)

    contract_address = '0xB8c77482e45F1F44dE1745F52C74426C631bDD52'
    contract_name = 'BNB'
    etherscan_only_source_code = True
    ...
    try:
        slither = Slither(CryticCompile(Etherscan(contract_address),etherscan_only_source_code = etherscan_only_source_code,etherscan_api_key=etherscan_api_key,export_dir =export_dir,etherscan_export_dir =etherscan_export_dir))
